...
Lead with purpose, exact product/release, observed coverage/grain, access requirements, last test and a clear source action. Consolidate repetitive unresolved sections.

**Verify:** The HCRIS page does not claim source-asserted inferred units or hide its supported API example below boilerplate.
