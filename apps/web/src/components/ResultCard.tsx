...
export function ResultCard({ result, displayRank }: ResultCardProps) {
  const metadataLeft = [
    { label: 'Why it matched', value: result.whyMatched, Icon: Target },
  ...
  const metadataRight = [
    ...
    { label: 'Latest verified release', value: result.latestVerifiedRelease, Icon: BarChart3 },
    { label: 'Variables/codebook', value: result.variablesCodebook, Icon: FileText },
  ]
