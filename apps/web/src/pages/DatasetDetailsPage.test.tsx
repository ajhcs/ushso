...
describe('identity-bound research-use guidance', () => {
  ...
  it('does not claim source-asserted inferred units or treat a documentation page as proven payload access', async () => {
    ...
    expect(summary).toContain('Inferred unit tags are search aids only')
    expect(summary).toContain('are not source-asserted observation grain')
    expect(summary).not.toMatch(/are source-asserted observation grain/)
