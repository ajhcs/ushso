...
// Execution-time authorization (run-payload-retrieval-pilot.mjs --execute) still
// enforces exact candidate HEAD + AUTH binding + endpoints + frozen SHA + budget
// before any fetch.
export const PILOT_HISTORICAL_BRANCH = EXPECTED_BRANCH;
