# WP11 v1.2 implemented successor — scoped technical attestation

Run `npm test --prefix verification/wp11/v1.2.0` for technical and adversarial
tests; `npm run receipt:draft --prefix verification/wp11/v1.2.0` for a deterministic
...
`verification/wp11/v1.1.0/receipts/approved.json`; that receipt is immutable
historical input and no v1.2.0 approval or receipt is copied into this package.
...
`verification/wp0/v1.3.0/README.md` and enforced by the common support module.
