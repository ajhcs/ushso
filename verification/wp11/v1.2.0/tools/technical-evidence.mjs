...
const previousSuccessorPath = 'verification/wp11/v1.1.0/receipts/approved.json';
const previousSuccessorSha256 = '8db322fe1c09b34829e7e0e64a869a606cb8099dbf6f7d13874ee3b09ae0d85f';
...
async function readPreviousSuccessor() {
  ...
  assert(receipt.package_id === '@ushso/wp11-verification-v1.1.0@1.1.0', 'WP11_PREVIOUS_SUCCESSOR_WRONG_PACKAGE');
...
for(const relative of [...new Set([...implementationPaths,...scope,
 ...
 ...await listFiles(REPO,'verification/wp11/v1.2.0'),
...
return {status:'PASS',schema_version:'ushso-wp11-technical-evidence.v1.2.0',work_package:'WP11',
 ...
 files,file_set_sha256:digest('ushso:wp11-implementation-file-set:v1.2\n',files),
