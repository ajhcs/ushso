...
export const packageId = '@ushso/wp0-verification-v1.3.0@1.3.0';
const execute = promisify(execFile);
const oldRoot = 'verification/wp0/v1.0.0/receipts';
const previousSuccessorPath = 'verification/wp0/v1.2.0/receipts/approved.json';
const previousSuccessorSha256 = '3accfe1144e793087b29b391972bacec8cd105c6dfedceca548bfa4e656cbdac';
...
export const historicalMapping = {
  'packages/retrieval/tools/query-schema.mjs': 'verification/wp0/v1.3.0/historical-algorithms/query-schema.mjs',
  'packages/retrieval/tools/webmcp.mjs': 'verification/wp0/v1.3.0/historical-algorithms/webmcp.mjs'
};
...
export async function validatePreviousSuccessor() {
  ...
  assert.equal(receipt.package_id, '@ushso/wp0-verification-v1.2.0@1.2.0', 'WP0_PREVIOUS_SUCCESSOR_WRONG_PACKAGE');
...
export async function buildTechnicalEvidence() {
  ...
  const names = ['verification/successor-support.mjs', 'package.json', 'package-lock.json', 'tests/product-boundary.test.mjs',
    ...verificationLogic, ...await listFiles(repoRoot, 'verification/wp0/v1.3.0'), ...await listFiles(repoRoot, 'packages/retrieval/tools'), ...await listFiles(repoRoot, 'worker')];
