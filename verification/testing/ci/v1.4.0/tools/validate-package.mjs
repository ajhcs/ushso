...
export const packageId = '@ushso/ci-verification-successor-v1-4@1.4.0'
export const predecessorSha256 = '6e27725cf531e1ced3d546503176af8ae4157366e97594c49ca5c9d2c18215cd'
export const previousSuccessorPath = 'verification/testing/ci/v1.3.0/receipts/approved.json'
export const previousSuccessorSha256 = '8013e0b4700d781a365540e046cd6ac15c8eb1999aca956b30c73591ad648d4b'
...
export async function assertPreviousSuccessorPreserved() {
  const bytes = await readFile(new URL('../../v1.3.0/receipts/approved.json', import.meta.url))
  assert.equal(sha256(bytes), previousSuccessorSha256, 'CI_PREVIOUS_SUCCESSOR_CHANGED')
  const receipt = JSON.parse(bytes.toString('utf8'))
  assert.equal(receipt.package_id, '@ushso/ci-verification-successor-v1-3@1.3.0', 'CI_PREVIOUS_SUCCESSOR_WRONG_PACKAGE')
...
export async function buildTechnicalEvidence() {
  ...
  return {
    ...
    implementation_files: await pinFiles(repositoryRoot, [
      'verification/successor-support.mjs',
      ...await listFiles(repositoryRoot, 'verification/testing/ci/v1.4.0'),
      'scripts/run-contract-suites.mjs',
      'scripts/verify-ci-attestation.mjs',
    ]),
    evidence_scope: 'structural CI v1.4 inventory; discovered suites have not been executed by this builder',
  }
}
