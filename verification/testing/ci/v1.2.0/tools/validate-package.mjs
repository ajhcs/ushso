...
export const packageId = '@ushso/ci-verification-successor-v1-2@1.2.0'
export const predecessorSha256 = '6e27725cf531e1ced3d546503176af8ae4157366e97594c49ca5c9d2c18215cd'
export const previousSuccessorPath = 'verification/testing/ci/v1.1.0/receipts/approved.json'
export const previousSuccessorSha256 = '60e651bbb191ed3a5190586924f96481f8251a12d5be378f33c8cbce96bd81ed'
...
export async function assertPreviousSuccessorPreserved() {
  const bytes = await readFile(new URL('../../v1.1.0/receipts/approved.json', import.meta.url))
  assert.equal(sha256(bytes), previousSuccessorSha256, 'CI_PREVIOUS_SUCCESSOR_CHANGED')
  const receipt = JSON.parse(bytes.toString('utf8'))
  assert.equal(receipt.package_id, '@ushso/ci-verification-successor-v1-1@1.1.0', 'CI_PREVIOUS_SUCCESSOR_WRONG_PACKAGE')
...
export async function buildTechnicalEvidence() {
  ...
  return {
    ...
    implementation_files: await pinFiles(fileURLToPath(new URL('../../../../../', import.meta.url)), [
      ...
      ...await listFiles(fileURLToPath(new URL('../../../../../', import.meta.url)), 'verification/testing/ci/v1.2.0'),
    ]),
