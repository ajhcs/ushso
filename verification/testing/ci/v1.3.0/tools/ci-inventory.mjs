...
export async function buildCiIntegrationReceipt() {
  ...
  const inputs = await Promise.all([
    ...
    'verification/testing/ci/v1.3.0/README.md',
    'verification/testing/ci/v1.3.0/package.json',
    'verification/testing/ci/v1.3.0/tests/ci-integration.test.mjs',
    'verification/testing/ci/v1.3.0/tools/ci-inventory.mjs',
    'verification/testing/ci/v1.3.0/tools/validate-package.mjs',
  ].map(pin))
