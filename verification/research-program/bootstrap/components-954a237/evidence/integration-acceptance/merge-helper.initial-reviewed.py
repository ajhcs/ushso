...
def api(path):
    return json.loads(run('gh', 'api', 'repos/ajhcs/ushso/' + path))
...
def live_ci_guard():
    ...
    save('live-ci-before-merge.json', {'run': live, 'jobs': jobs})
