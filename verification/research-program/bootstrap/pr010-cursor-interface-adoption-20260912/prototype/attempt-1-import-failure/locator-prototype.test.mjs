...
function twoPages(h){
  h.transport.add('GET',BASE,jsonResponse({dataset:[{identifier:'fixture-a',title:'Fixture A'}],next_cursor:'page-2'},{etag:'"fixture-page-1"'}));
  h.transport.add('GET',BASE+'?cursor=page-2',jsonResponse({dataset:[{identifier:'fixture-b',title:'Fixture B'}]},{etag:'"fixture-page-2"'}));
}
